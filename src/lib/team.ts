...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    bio: [
      "Andrea Toto Brocchi is a dynamic renewable energy strategist combining technical depth with financial acumen. With more than a decade of experience across Latin America and Europe, he has structured and financed infrastructure and clean energy initiatives—developing bankable solutions that balance environmental impact with long-term returns.",
